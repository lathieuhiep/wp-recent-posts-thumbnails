...
( function( $ ) {
    ...
    $( document ).ready( function () {
        ...
        let wp_recent_posts_thumbs_widget   =   $( '.wp_recent_posts_thumbs_widget' ),
            recent_post_prev                =   $( '.wp_recent_posts_thumbs_prev' ),
            ...
            $.ajax({
                ...
                success: function( data ) {
                    ...
                    if ( data ) {
                        ...
                        wp_recent_posts_thumbs_widget.empty().append( data );
